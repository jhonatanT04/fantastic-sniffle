...
a persistence unit "practicaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "practica/pom.xml":
...
artifact ("practica.war") is already built. You can build
